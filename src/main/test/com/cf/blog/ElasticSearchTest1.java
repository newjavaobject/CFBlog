...
public class ElasticSearchTest1 {
    ...
    public void init() throws UnknownHostException {
        Settings settings = Settings.builder()
                .put("cluster.name", "application1").build();
...
//        System.out.println(response3.getSourceAsString());
    ...
    public void elasticBulk() throws IOException {
        ...
        for (int i = 10000;i < 90000;i++){
            bulkRequest.add(client.prepareIndex("test", "data", i+"")
                    .setSource(jsonBuilder()
                            .startObject()
                            .field("d1", i+"")
                            .field("d2", "kjasdfjoaipsejrownelkn")
                            .field("d3", "kjasdfjoaipsejrownelkn")
                            .field("d4", "kjasdfjoaipsejrownelkn")
                            .field("d5", "kjasdfjoaipsejrownelkn")
                            .field("d6", "kjasdfjoaipsejrownelkn")
                            .field("d7", "kjasdfjoaipsejrownelkn")
                            .field("d8", "kjasdfjoaipsejrownelkn")
                            .field("d9", "kjasdfjoaipsejrownelkn")
                            .field("d10", "阿斯顿节反扒第三方阿萨德快乐分配哦姐啊时代科技发生地方jo埃索达福娃看了几分；可是辣椒粉；拉萨扩大解放")
                            .endObject()
                    )
            );
            if (i % 100 == 0) {
